    ...
    <div>
        ...
        <el-dialog
            ...
            <div style="text-align: center">
                ...
                <img :src="imgUrl" alt="转账二维码" style="width: 180px; height: 240px">
            </div>
...
<script>
    ...
    import {WxPay} from "../../../api/personal";
    ...
    export default {
        ...
        methods: {
            netPay_like() {
                ...
                let _this = this
                WxPay({uid: _this.uid, amount_of_account: _this.amount_of_account}).then(function (data) {
